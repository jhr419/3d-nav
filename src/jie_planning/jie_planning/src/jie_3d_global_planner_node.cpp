...
class Jie3DGlobalPlannerNode : public rclcpp::Node
{
public:
  Jie3DGlobalPlannerNode()
  : Node("jie_3d_global_planner_node"),
    ...
    tf_listener_(tf_buffer_)
  {
    ...
    goal_pose_sub_ = create_subscription<geometry_msgs::msg::PoseStamped>(
      ...
      std::bind(&Jie3DGlobalPlannerNode::onGoalPose, this, std::placeholders::_1));
    goal_point_sub_ = create_subscription<geometry_msgs::msg::PointStamped>(
      goal_point_topic, rclcpp::QoS(10),
      std::bind(&Jie3DGlobalPlannerNode::onGoalPoint, this, std::placeholders::_1));
    initial_pose_sub_ = create_subscription<geometry_msgs::msg::PoseStamped>(
      initial_pose_topic, rclcpp::QoS(10),
      std::bind(&Jie3DGlobalPlannerNode::onInitialPose, this, std::placeholders::_1));
    octomap_sub_ = create_subscription<octomap_msgs::msg::Octomap>(
      octomap_topic, rclcpp::QoS(1).transient_local().reliable(),
      std::bind(&Jie3DGlobalPlannerNode::onOctomap, this, std::placeholders::_1));
    ...
    publish_map_timer_ = create_wall_timer(
      std::chrono::seconds(2), std::bind(&Jie3DGlobalPlannerNode::publishMapProducts, this));

    RCLCPP_INFO(
      get_logger(),
      "jie_3d_global_planner_node started. goal_pose=%s goal_point=%s initial_pose=%s "
...
private:
  ...
  void tryPlan()
  {
    ...
    GlobalPlanner3D::Options options;
    ...
    GlobalPlanner3D planner(map_, options);
...
int main(int argc, char ** argv)
{
  ...
  rclcpp::spin(std::make_shared<jie_planning::Jie3DGlobalPlannerNode>());
  rclcpp::shutdown();
  return 0;
}
