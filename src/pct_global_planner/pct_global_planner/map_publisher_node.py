...
class PCTGlobalMapPublisher(Node):
    def __init__(self):
        ...
        self.declare_parameter("pcd_dir", "/home/jhr/3dnav_ws/maps")
        self.declare_parameter("pcd_file", "/home/jhr/3dnav_ws/maps/map.pcd")
        self.declare_parameter("tomogram_dir", "/home/jhr/.ros/pct_planner/tomogram")
        self.declare_parameter("tomogram_file", "map_leveled")
